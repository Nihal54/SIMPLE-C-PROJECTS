//PROJECT NAME : SIMPLE ONLINE SHOPPING 
//STUDENT NAME : NIHAL JUBER SAYYAD


//PROJECT DESCRIPTION:
/*

This C++ code appears to be a simple program for simulating a shopping experience 
where the user can select different electronic items (mobile phones, laptops, desktops, speakers, headphones) 
and accumulate a total bill based on their choices. Here are some comments to explain important topics in the code:
...
// Function to handle mobile selection
int Mobile()
{
    cout<<endl;
            ...
            reselectm:  // Label for reselecting in case of invalid input
            ...
            mobil1:   // Input for selecting a mobile
            cin>>mobile;
            ...
            // If the user wants to continue shopping, go back to item selection
